...
* Add `getCurrentStatus` method (Android/iOS) and Dart wrapper `ZebraPrinter.getCurrentStatus()` to return `ZebraStatus` enum (maps SDK messages like "Ready To Print" to `connected`).
